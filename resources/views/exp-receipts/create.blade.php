    ...
    <div class="container pt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb p-3 d-flex justify-content-between">
                <div class="pull-right mb-4 mt-3">
                    <h4>اضافة ايصال مصروف </h4>
                </div>
                <div class="pull-right">
                    <a class="btn bg-gray-dark" href='{{route('expenses.index')}}'> رجوع</a>
                </div>
            </div>
        </div>
        @if(session('status'))
        ...
        @endif
        <form action="{{ route('exreceipt.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control m-bot15 main_select" name="expense_id" >
                            <option disabled selected value="">بحث او اختيار اسم المصروف</option>
                            @if ($expenses->count() > 0)
                ...
                <div class="col-xs-4 col-sm-4 col-md-8 row" id="check_inputs" @if ($revenueType !== 2) style="display:none;" @endif>                   <div class="col-xs-6 col-sm-6 col-md-4">
                        <div class="form-group">
